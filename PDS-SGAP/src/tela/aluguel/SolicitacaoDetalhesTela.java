...
public class SolicitacaoDetalhesTela extends javax.swing.JFrame {
    ...
    public SolicitacaoDetalhesTela(SolicitacaoAluguel solicitacaoAluguel, Condomino condomino) {
    ...
    public void preencherCampos(){
        tfDono.setText(this.solicitacaoAluguel.getProduto().getCondomino().toString());
        tfProduto.setText(this.solicitacaoAluguel.getProduto().getNome());
        tfDescricao.setText(this.solicitacaoAluguel.getProduto().getDescricao());
        tfContato.setText(this.solicitacaoAluguel.getProduto().getCondomino().getTelefones().get(0));
        tfDiaria.setText("R$"+this.solicitacaoAluguel.getProduto().getDiaria());
        tfTaxa.setText(this.solicitacaoAluguel.getProduto().getTaxa()+"%");
       
        SpinnerNumberModel spModelQuantidade = new SpinnerNumberModel(this.solicitacaoAluguel.getProduto().getQuantidade(), 1, this.solicitacaoAluguel.getProduto().getQuantidade(), 1);
        spQuantidade.setModel(spModelQuantidade);
        spQuantidade.setValue( this.solicitacaoAluguel.getProduto().getQuantidade());
    ...
    public void telaAlugarProduto (){
       // SolicitacaoDetalhesTela telaAlugarProduto =  new SolicitacaoDetalhesTela(this.solicitacaoAluguel.getProduto(), this.condomino);
    ...
    private void carregarImagens(){
        ...
        img3.removeAll();
        int cont = 1;
        for (ImagemProduto imagem: this.solicitacaoAluguel.getProduto().getImagensProduto()) {
    ...
    public void preencherSolicitacao(){
        ...
        this.solicitacaoAluguel.setProduto(this.solicitacaoAluguel.getProduto());
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SolicitacaoDetalhesTela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
